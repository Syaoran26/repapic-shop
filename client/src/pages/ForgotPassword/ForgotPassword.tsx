    ...
    <div className="max-w-[420px] w-full bg-white rounded-2xl py-10 px-6 shadow-sm">
      ...
      <div className="h-24">
        <svg className="h-full mx-auto" fill="none" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
          ...
          ></path>
          <g filter="url(#filter0_i_1870_135517)" style={{ mixBlendMode: 'overlay' }}>
            <path
              fill="#fff"
              fillOpacity="0.04"
          ...
          <path
            ...
            clipRule="evenodd"
          ></path>
          <g filter="url(#filter1_i_1870_135517)" style={{ mixBlendMode: 'overlay' }}>
            <path
              fill="#fff"
              fillOpacity="0.04"
              fillRule="evenodd"
      ...
      <div className="flex flex-col gap-2 mt-6 mb-10 text-center">
        <h3 className="text-2xl md:text-3xl lg:text-[2rem] font-bold">Quên mật khẩu?</h3>
