...
const PRODUCTS: Product[] = [
  {
    title: '(Couple) Tranh tự thiết kế',
    thumbnail:
  ...
  {
    title: '(Nhóm bạn) Tranh tự thiết kế',
    thumbnail:
  ...
  {
    title: '(Gia đình) Tranh tự thiết kế',
    thumbnail:
